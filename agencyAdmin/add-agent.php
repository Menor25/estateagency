                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            name="first_name" value="<?php if(isset($first_name)){ echo $first_name;} ?>"
                                            required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            name="last_name" value="<?php if(isset($last_name)){ echo $last_name;} ?>"
                                            required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            name="other_name" <?php if(isset($other_name)){ echo $other_name;} ?>>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <select class="form-control show-tick" name="gender" required>
                                            <?php
                                                if(isset($gender)) {
                                                    ...
                                                    echo "<option value='' disabled selected>-- Gender --</option>";
                                                }
                                            ?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            name="username" value="<?php if(isset($username)){echo $username;} ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            value="<?php if(isset($confirm_password)){echo $confirm_password;} ?>" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php if(isset($city)){echo $city;} ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="State" name="state" 
                                            value="<?php if(isset($state)){echo $state;} ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-group">
                                        <select class="form-control show-tick" name="country" required>
                                                <?php 
                                                    if(isset($country)){ echo $country;} else {
                                                ?>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="agent_photo" type="file" -d="formFileLg"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            ><?php if(isset($biography)){ echo $biography;} ?></textarea>
                                        </div>
