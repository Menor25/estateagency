                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-lg-7 col-md-6 text-center">
                                    ...
                                    <small class="displayblock">47% Average <i
                                            class="zmdi zmdi-trending-up"></i></small>
                        ...
                        <div class="city-selected body l-khaki">
                            <div class="row">
                                ...
                                <div class="icon col-5">
                                    <img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/weather/summer.svg"
                                        alt="">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="carousel-item text-center active">
                                    <div class="col-12">
                                        <ul class="row days-list list-unstyled">
                                            <li class="day col-4">
                                                <p>Monday</p>
                                                <img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/weather/rain.svg"
                                                    alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Tuesday</p>
                                                <img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/weather/cloudy.svg"
                                                    alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Wednesday</p>
                                                <img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/weather/wind.svg"
                                                    alt="">
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="carousel-item text-center">
                                    <div class="col-12">
                                        <ul class="row days-list list-unstyled">
                                            <li class="day col-4">
                                                <p>Thursday</p>
                                                <img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/weather/sky.svg"
                                                    alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Friday</p>
