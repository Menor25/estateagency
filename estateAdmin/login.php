...
<nav class="navbar navbar-expand-lg fixed-top navbar-transparent">
    <div class="container">        
        <div class="navbar-translate n_logo">
            <a class="navbar-brand" href="#" title="" target="_blank"><h4 class="text-light mt-0">Elema Igie Ventures</h4></a>
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link btn btn-primary btn-round" href="add-agent">SIGN UP</a>
                </li> -->
            </ul>
        </div>
    </div>
                ...
                <form class="form" method="POST" action="">
                    <div class="header">
                        <div class="logo-container">
                            ...
                            <img src="images/Elema-igie.PNG" alt="" width="200px">
                        </div>
                        <h5>Log in</h5>
                    </div>
                    <div class="content">                                                
...
<!-- Mirrored from www.wrraptheme.com/templates/compass/estate/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Apr 2022 08:05:29 GMT -->
</html>