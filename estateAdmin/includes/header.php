<?php
    require_once "../estateAdmin/private/autoload.php";
    require_once "../estateAdmin/private/init.php";
...
<head>
    ...
    <title>Elema Igie Ventures - Admin</title>
    ...
    <link rel="stylesheet" href="../../estateagency/assets/css/style.css">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="assets/images/logo.svg" width="48" height="48" alt="Elema Igie Ventures"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<nav class="navbar">
    <div class="col-12">        
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home"><img src="assets/images/logo.svg" width="30" alt="Compass"><span class="m-l-10">Estate</span></a>
        </div>
