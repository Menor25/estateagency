...
if (Is_Post_request()) {
    ...
    // C:\xampp\htdocs\estateagency\estateAdmin\images\agent
    // C:\xampp\htdocs\estateagency\estateAdmin\images\agent
}
// echo __DIR__ . "\images\agent";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    value="<?php if(isset($other_name)){ echo $other_name;} ?>" 
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php 
                                    if(isset($gender)){ echo $gender;} else {
                                ?>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12 dropzone" id="frmFileUpload" >
                                    <div class="fallback">
                                        <input name="agent_photo" class="form-control"
                                        value="<?php if(isset($agent_photo)){ echo $agent_photo;} ?>" 
                                        type="file" multiple />
                                    </div>
